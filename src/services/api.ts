...
const API_URLS = {
  getParticipants: 'https://functions.poehali.dev/7e57c4aa-6302-4340-8648-d25ebb52312e',
  importParticipants: 'https://functions.poehali.dev/eb47b524-75f9-4c36-8ba4-13e4d746f257'
};
...
export class ApiService {
  static async getParticipants(search?: string, cluster?: string): Promise<ParticipantsResponse> {
  ...
  static async importParticipants(participants: any[]): Promise<ImportResponse> {
