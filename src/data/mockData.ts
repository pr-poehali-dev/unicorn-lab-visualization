...
export const entrepreneurs: Entrepreneur[] = [
  {
    ...
    cluster: 'ИТ и Цифровые технологии',
...
export const clusterColors: { [key: string]: string } = {
  'ИТ и Цифровые технологии': '#ea580c',
  'Электронная коммерция': '#dc2626', 
  'Образование': '#ca8a04',
  'Медицина и здоровье': '#059669',
  'Финансы и банкинг': '#7c3aed'
};